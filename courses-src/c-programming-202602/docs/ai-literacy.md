...
## AI와 함께 '개발'하기 — 학습을 넘어 설계로
공부(개념·디버깅)를 넘어 **개발**로 가면, 핵심 역량은 타이핑이 아니라
**무엇을 만들지 설계하고 AI의 결과를 검증·통합**하는 것이다.

설계 우선 5단계: 요구사항 → 자료구조 → 함수 분해 → 구현 → 검증.

!!! tip "직접 해보기"
    프로그램 **설계 문제 6선**으로 설계→구현→검증을 연습하자 → [🧩 프로그램 설계 문제](design-problems.md)
