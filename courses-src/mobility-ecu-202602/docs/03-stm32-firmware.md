...
!!! note "이번 학기 구현 기준"
    실습 기준 MCU는 **STM32H7 계열**이며, HAL 없이 레지스터 직접 제어로 원리를 확인한다. F767·F103·ESP32 첨부자료는 주변장치 구조와 추상화 수준을 비교하기 위한 참고 예시로 사용한다.
...
- 교육흐름 권장: **STM32H7 레지스터 직접 제어**를 구현 기준으로 두고, F767 예시로 메모리맵 사고방식을 비교한 뒤, F103 HAL 자료는 생산성·추상화 수준을 설명할 때만 사용한다.
