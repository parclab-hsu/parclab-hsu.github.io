...
> UAV·우주로버 및 소형 전동 플랫폼(전동킥보드·인휠 BLDC)의 **전기전자제어유닛(ECU)** 을 전자부품 기초부터 회로·PCB·STM32 펌웨어까지 단계적으로 설계·구현하고, 최종적으로 BLDC 구동 제어유닛을 통합·시연한다.
...
- **캡스톤(심화)**: [UGV 개발 프로젝트](ugv-project.md) — WIZnet 사례를 각색해 직접 만들며 마이크로프로세서를 이해하고 개발 자신감을 키운다.
