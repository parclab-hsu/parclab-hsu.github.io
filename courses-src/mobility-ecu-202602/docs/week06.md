...
!!! tip "교수자용 — 6주차 운영 자료"
    [🗓️ 운영 키트](week06-kit.md) (180분 진행 대본·준비물·판서·계측 안전) · [🖨️ 배포용 워크시트](week06-worksheets.md) (인쇄해서 나눠 주는 양식)
...
> 📚 이번 주 용어의 자세한 설명과 그림은 **[주차별 용어 정리 — 6주차](terms-by-week.md#week06)** 에 있다.
...
> 이 사례노트는 `3상 인버터와 PWM`를 실제 로버, 산업용 AMR, 차량 ECU 문제로 연결한다.
