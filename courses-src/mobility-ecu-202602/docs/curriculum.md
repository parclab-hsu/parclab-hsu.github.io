...
!!! note "Part별 운영 관점"
    1~4주차는 전원·부품 기반, 5~7주차는 모터 동역학·인버터·PI 제어, 8~10주차는 STM32H7 레지스터 직접 제어, 11~14주차는 HSI·하드웨어·PCB·검증, 15주차는 로버(AMR)/우주 로버 시연과 포트폴리오 발표로 운영한다.
...
## 평가
출석·참여 10% / 실습 과제 20% / 중간 설계발표 20% / 팀 프로젝트 30% / 대회 미션 수행 20%

## 최종 프로젝트
로버(AMR) 2륜 구동 제어유닛(우주 로버 대회 적용) 설계+펌웨어 분석. 산출물: 요구사항명세서, HSI, 시스템블록도, 회로도, PCB배치, 펌웨어 구조도, 구동코드 분석/시연, 최종 미션 로그.
