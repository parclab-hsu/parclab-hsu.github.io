...
!!! tip "교수자용 — 공식 10주차 · STM32 펌웨어 2(EXTI·ADC·Timer·UART) — 이 페이지의 EXTI 부분이 해당한다 운영 자료"
...
> 📚 이번 주 용어의 자세한 설명과 그림은 **[주차별 용어 정리 — 9주차](terms-by-week.md#week09)** 에 있다.
...
> 이 사례노트는 `EXTI, 클럭, 엔코더 이벤트`를 실제 로버, 산업용 AMR, 차량 ECU 문제로 연결한다.
