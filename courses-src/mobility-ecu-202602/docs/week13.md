...
!!! tip "교수자용 — 공식 13주차 · 회로도·PCB 설계 운영 자료"
    [🗓️ 운영 키트](week13-kit.md) · [🖨️ 배포용 워크시트](week13-worksheets.md)
...
!!! info "이미지로 설명하기"
    ![첨부자료 대표 이미지](figures/attachment-previews/pcb-design-routing-screen-p15.png)
...
!!! quote "슬라이드 이미지 1 · 첨부자료 대표 이미지"
    ![13주차 첨부자료 대표 이미지](figures/attachment-previews/pcb-design-routing-screen-p15.png)

    EasyEDA 라우팅 화면에서 pad, trace, net, board outline을 짚고 회로도 연결이 PCB 구리 경로로 바뀌는 과정을 설명한다.

!!! quote "슬라이드 이미지 2 · 핵심 도해"
    ![13주차 핵심 도해](figures/grounding.svg)
...
> 📚 이번 주 용어의 자세한 설명과 그림은 **[주차별 용어 정리 — 13주차](terms-by-week.md#week13)** 에 있다.
...
![첨부자료 미리보기](figures/attachment-previews/pcb-design-routing-screen-p15.png)

![주차 핵심 도해](figures/grounding.svg)

###### 강의 핵심 초점

- 회로도·PCB 설계 기초의 중심 질문은 "회로도와 PCB 배치가 최종 로버 ECU에서 어떤 문제를 해결하는가"이다.
...
4. 전원, PWM, UART, ADC 테스트포인트를 최소 하나씩 추가한다. 결과를 다음 주차 산출물에 어떻게 반영할 것인가?

###### 강의자료-실습 통합 절차

##### 수업 전 5분 준비

- 메인 페이지의 핵심 도해와 `figures/attachment-previews/pcb-design-routing-screen-p15.png` 이미지를 같은 화면에 열어 둔다.
...
> 이 사례노트는 `회로도와 PCB 배치`를 실제 로버, 산업용 AMR, 차량 ECU 문제로 연결한다.
...
- "본 실험은 회로도와 PCB 배치를 로버 ECU 관점에서 검증하기 위해 수행하였다."
...
| 자료 | 수업 중 쓰는 장면 |
|---|---|
| [pcb-design-lecture-v0.1.pdf](attachments/pcb-design-lecture-v0.1.pdf) **(원본 자료)** | EasyEDA, 레이어, 배선 규칙의 주교재 |
| [inverter-hardware-design-v0.1.pdf](attachments/inverter-hardware-design-v0.1.pdf) **(원본 자료)** | 구동보드 회로 블록을 PCB로 옮기는 참고 자료 |
