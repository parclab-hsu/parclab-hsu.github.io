...
!!! quote "출처 (Sources)"
    본 모듈은 도서 **『피지컬 AI 시스템 설계』 16장 LeRobot 실습**(저자: 엥지유니버스, 한빛미디어)의 예제와 **HuggingFace LeRobot 공식 문서**를 바탕으로 재구성하였습니다. 예제 코드 저장소: **[engiengi/Physical-ai-system-design](https://github.com/engiengi/Physical-ai-system-design)**.
