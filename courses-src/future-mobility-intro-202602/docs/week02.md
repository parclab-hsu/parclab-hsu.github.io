...
> 서술형 1번 단골: *"자율 주행 기술이 필요한 이유와 그 핵심 가치에 대하여 설명하시오."* → **안전(94%) · 효율(비용·에너지) · 접근성(교통약자)** 세 축으로 답하면 된다.
...
1. 세종시 사례에서 볼 때, 자율주행차의 **상용화 확대를 위해 해결해야 할 이슈**는 무엇인가? (기술 / 제도 / 수용성으로 나누어 답해 보자)
2. 자율주행차의 등장으로 **새롭게 생겨나는 직업**이 있을까? (제주 라이드플럭스 안전요원 사례 — 안전요원이 갖추어야 할 요건과 역할은?)
3. 임시운행허가 유형을 A/B/C로 나눈 이유는 무엇일까? 각 유형에 다른 안전요건이 필요한 까닭은?
