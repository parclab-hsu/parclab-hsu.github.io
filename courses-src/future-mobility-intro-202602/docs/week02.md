...
!!! abstract "심화로 이어보기"
    자율주행시스템이 **고장 났을 때** 어떤 절차로 운전자에게 제어권을 넘기고, 그동안 차량이 어떻게 스스로 궤도를 유지하는지는 1주차 심화 자료에서 다룬다. → [🛡️ 심화 · 자율주행 안전 아키텍처](safety-architecture.md)
...
!!! tip "정리 — 자율주행 발전에 관한 세 가지 사실"
    - 최초의 자율주행 시스템은 **통신 기반 기술에서 출발**했다
