...
!!! success "산림보호·재해 감시에 적합한 센서 조합"
    **EO/IR 복합 센서 + 열화상 카메라**. EO는 가시광 전자광학, IR은 적외선으로,
    주간 식별과 야간·연기 속 열원 탐지를 함께 커버한다.
...
| 분야 | 내용 |
|---|---|
| **정밀농업** | 작물 생육 상태 분석, 비료·농약 자동 살포 |
| **산업·시설관리** | 스마트 인프라 점검. LiDAR·열화상 카메라로 교량·댐 등 자율점검 |
| **물류** | 드론 택배, 긴급 의약품 수송 |
| **재난·안전** | 재난지역 실시간 모니터링 |
| **국방** | 정찰·감시·공격 |
| **엔터테인먼트** | 드론 라이트쇼, 드론축구·드론농구, 항공촬영 |
| **모빌리티** | eVTOL 기반 도심항공교통(사람 또는 화물 수송) |

### 활용 기법의 기술적 진화

- **센서융합(Fusion)** — LiDAR + RGB + 열화상 + GPS 데이터를 결합
- **군집비행(Swarm)** — 다수 드론이 분산 제어로 협력 수행
- **AI 기반 자율 비행** — 객체인식·경로계획·충돌회피 자동화
- **하이브리드 추진** — 전기·수소 연료전지 기반 장거리 비행

> **K-드론 시스템** — 항공안전기술원이 주관하는 우리나라의 드론 교통관리 체계다. 상세는 [12주차](week12.md) UTM 절에서 다룬다.
...
!!! warning "AI가 필수가 되는 지점"
    **날다·찍다는 자동화 단계로도 가능**하고, **운반하다·지키다부터 AI가 필수**가 된다.
...
!!! success "국내 법률의 공통 목적"
    자율주행차법 · 드론법 · 스마트도시법은 모두 **새로운 산업의 창출과 활용 촉진을 위한 제도적 기반 마련**을 목적으로 한다.
...
!!! warning "플랫폼 연구와 기체 설계는 다르다"
    - **고정익 기체의 날개 형상 해석**은 플랫폼 기반 드론 연구가 아니라 **기체 설계 영역**이다.
    - **정밀 타격을 위한 미사일 운용 체계**는 무인 이동체 기술 영역으로 보기 어렵다.
...
1. **드론의 상업적 활용 확대에 따라 가장 먼저 고려되어야 할 법적 쟁점**은 무엇인가? 수집 영상의 개인정보·사생활 침해가 고도·주파수·중계시스템 문제보다 먼저 다뤄져야 하는 이유는 무엇인가?
...
▶️ **다음 주 예고** — 드론을 **직접 설계**하는 관점으로 들어간다. 강성과 강도는 어떻게 다른가, 안전계수를 높이면 왜 무거워지는가, 배터리를 무엇으로 바꿔야 30분을 날 수 있는가. **이 과목에서 유일하게 숫자를 직접 다루는 주차다.** → [11주차](week11.md)
