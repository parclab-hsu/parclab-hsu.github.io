...
강의계획서 원안은 [Syllabus](syllabus.md)에 그대로 두었고, 이 페이지는 **직전 운영분(2026-1학기)에서 실제로 진행된 순서**다. 2026-2학기도 이 순서를 따르며, **표의 일자는 2026-1학기 운영 기준**이므로 개강 후 갱신한다.

## 마스터 표

| 주 | 주제 | 강의 덱 (2026-1학기 운영일) | 핵심 키워드 |
|---:|---|---|---|
...
| 15 | **[기말고사](week15.md)** | — | 9~14주차 |

## 원안 대비 무엇이 바뀌었나

| 계획서 원안 | 실제 운영 | 사유 |
|---|---|---|
| 3주 자율주행 AI · 4주 핵심기술 | 3~4주 AI 기초, 5~7주 센서·프로세서·통신 | 자율주행 파트를 **3주 확대** — 이 과목의 기초가 되는 영역 |
| 5~6주 드론 | 9~11주 드론 | 후반부로 이동, **구조설계 주차 신설**(11주) |
