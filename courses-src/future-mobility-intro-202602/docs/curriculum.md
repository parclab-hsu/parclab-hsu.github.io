...
강의계획서 원안은 [Syllabus](syllabus.md)에 그대로 두었고, 이 페이지는 **직전 운영분(2026-1학기)에서 실제로 진행된 순서**다. 2026-2학기도 이 순서를 따르며, **표의 일자는 2026-1학기 운영 기준**이므로 개강 후 갱신한다. 시험 범위는 이 표를 기준으로 한다.
