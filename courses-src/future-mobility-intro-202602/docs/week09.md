...
!!! danger "시험 포인트"
    무게 구간 **12kg / 150kg** 두 경계는 규제가 갈리는 지점이라 자주 출제된다.
...
1. 촬영용 드론과 물류 배송용 드론은 형태(고정익/회전익/하이브리드)를 어떻게 선택해야 하는가? 각각의 근거는?
2. 헥사콥터는 "모터 하나가 고장 나도 착륙 가능"하다. 쿼드콥터는 왜 안 되는가? 안전 관점에서 짝수/홀수 로터의 의미는?
3. FC에 IMU를 3개 두는 것은 비용 낭비인가? 항공 안전에서 **이중화(redundancy)**의 원칙을 어떻게 설명할 수 있나?
