...
-   :material-circle:{ style="color:#2e9e44" } [__진행중 · 현대차 L-Project 달 로버 12축 HILS 시스템__](projects/l-project-hils.md)
    ...
    [:octicons-arrow-right-24: 자세히 보기](projects/l-project-hils.md) · [:octicons-arrow-right-24: 중간 보고](projects/l-project-interim.md) · [:octicons-arrow-right-24: 차년도 과제 제안](projects/l-project-deformation.md)
