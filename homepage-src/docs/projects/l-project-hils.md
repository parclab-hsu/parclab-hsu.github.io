...
| 저장소 | 내용 | 규모 |
|---|---|---|
| `parclab-hsu/l-project-hils-ros2` | ROS2 패키지, EPOS4 에뮬레이터, Isaac/Nav2 설정, 배포 도구, 문서 14종 | 추적 파일 76개 · 커밋 58 (2026-08 기준) |
...
| 통합 회귀 시험 (`run_all_tests.sh`) | 위 시험 **6종 일괄 통과** (약 90초) — 인터프리터 자동 선택·잔존 노드 정리 포함 |
