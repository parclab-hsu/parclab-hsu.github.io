...
| 사업 | **총사업비 확정치 변동** — 협의 과정에서 공고문 지원규모와 크게 다른 값이 거론됨 | 예산 재작성 | 공고문 기준 **공식안 14.5억**을 본안으로 하고, 상향 확정 시 적용할 **확장안 26.0억**을 함께 준비. 구체 수치는 [OPEN-ITEMS](https://github.com/parclab-hsu/rfm-hansung-rr/blob/main/OPEN-ITEMS.md) 2번 |
