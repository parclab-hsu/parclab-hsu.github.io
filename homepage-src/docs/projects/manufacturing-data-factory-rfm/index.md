...
**연구개발비는 4년간 총 17.0억으로 확정되었습니다** — 한성대학교 **13.0억**,
모빌테크 **4.0억**. 모빌테크는 한성대 수행범위 안의 **공동개발기관**이며 차년도별
1.0억 균등입니다.
...
**모빌테크 4.0억**(전체의 약 23.5 %)은 **공간 Digital Twin 을 전 기간에 걸쳐** 담당합니다 —
1차 Pilot Scan·기준 Asset, 2차 공간 Twin 본 구축, 3차 Asset 보완·정합,
4차 실증 대상 Asset 갱신. 협약 형태는 **공동연구개발기관**이 적합합니다.
