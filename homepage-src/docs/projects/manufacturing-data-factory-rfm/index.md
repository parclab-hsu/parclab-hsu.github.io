...
!!! note "이 목표값의 성격"
    ...
    분모·반복횟수·산식·통계 기준은 <strong><a class="nowrap" href="roadmap.md">연차별 목표</a></strong> 의 측정 정의표에 있습니다.
...
세부 분모·산식·반복·통계 기준은 <strong><a class="nowrap" href="roadmap.md#kpi_1">연차별 목표</a></strong> 에서 확인합니다.
...
차년도별 목표·완료 Gate·완료 판정과 결과물 28건은 <strong><a class="nowrap" href="roadmap.md">연차별 목표</a></strong> 에 있습니다.
...
**현재 총 17.0억 배분안을 검토 중입니다** — 전액 한성대학교 배분입니다.
정부지원연구개발비 5 % 의 모수가 확정되기 전까지 금액을 확정값으로 표시하지 않습니다.

| 차년도 | 기간 | 연구개발비 | 근거 |
|---|---:|---:|---|
| 1차년도 | 9개월 | 3.3억 | 대상 선정·규격 확정 · Pilot Scan |
| 2차년도 | 10개월 | 4.4억 | 물리 가상환경 구축 · 공간 Twin 본 구축 |
| 3차년도 | 12개월 | 4.8억 | 데이터 생성·검수 · Asset 보완 |
| 4차년도 | 12개월 | 4.5억 | 순환 완주·실물 재검증 · Asset 갱신 |
| **합계** | **43개월** | **17.0억** | |

| 주요 역할 | 비중 | 금액 | 근거 |
|---|---:|---:|---|
| ① Real-to-Sim-to-Real 고도화 | 36 % | 6.1억 | 물성시험·보정·실물 대조가 이 항목에 몰림 |
| ② Zero-shot Transfer 도메인 적응 | 24 % | 4.1억 | 증강 조건 구성과 전이 평가 |
| ③ 엣지 케이스 시뮬레이션 | 25 % | 4.3억 | 실패 재현·복구 데이터 생성과 검증 |
| ④ 학술 연구·기술 자문 | 15 % | 2.5억 | 논문·특허·표준 제안과 자문 |
| **합계** | **100 %** | **17.0억** | |
...
- <strong><a class="nowrap" href="roadmap.md">연차별 목표</a></strong> — 차년도별 목표·완료 Gate·결과물 28건·KPI 측정 정의
