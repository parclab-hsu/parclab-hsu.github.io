...
**한성대학교 연구개발비는 4년간 총 17.0억으로 확정되었습니다.**

### 차년도별 배분

| 차년도 | 기간 | 비중 | 금액 | 근거 |
|---|---:|---:|---:|---|
| 1차년도 | 9개월 | 18 % | **3.1억** | 기간이 짧고 대상 선정·규격 확정 중심 |
| 2차년도 | 10개월 | 26 % | **4.4억** | 물리 가상환경 구축과 물성 실측이 몰림 — 기간 대비 밀도가 가장 높음 |
| 3차년도 | 12개월 | 29 % | **4.9억** | 데이터 생성·검수와 RFM 평가 |
| 4차년도 | 12개월 | 27 % | **4.6억** | 순환 완주와 실물 재검증 |
| **합계** | **43개월** | **100 %** | **17.0억** | |
...
!!! warning "통보 문구와 금액의 모수가 다릅니다 — 협약 전 확인 필요"
    2026-08-29 통보는 **「전체 정부지원연구개발비 기준 5 %」** 였습니다. 확정 금액 17억은
    **총사업비 340억의 5 %** 에 해당하며, 공고문상 정부지원연구개발비(75억)의 5 %
    (3.75억)와는 다릅니다. **협약서 근거 문구와 금액을 함께 확인해야 합니다.**

| 확인할 것 | 현재 상태 |
|---|---|
| 협약 근거 문구 | 「정부지원연구개발비의 5 %」로 적히면 금액이 달라집니다 |
