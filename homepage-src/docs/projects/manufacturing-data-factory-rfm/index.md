...
|---|---:|---:|
| **HSU-2. Deformation Engine** — 대표 성과 | **2.2** | 31% |
| HSU-4. Ontology·Edge Case | 1.1 | 16% |
| HSU-5. 학습데이터 생성 (학생 운영 포함) | 1.1 | 16% |
| HSU-3. 제조 로봇 시뮬레이션 | 1.0 | 14% |
| HSU-7. 공동 Testbed·Physical Validation | 0.6 | 9% |
| HSU-1. Use Case·Interface 설계 | 0.5 | 7% |
| HSU-6. RFM 연계 | 0.5 | 7% |
| **합계** | **7.0** | 100% |
...
|---|---:|---:|---:|---|
| 1차년도 (9개월) | 1.3 | 0.6 | 1.9 | Use Case·공통 Interface, Pilot Scan, 기준 3D Asset·물성 Schema, Ontology v1, Teleoperation·안전 Protocol |
| 2차년도 | 2.0 | 1.0 | 3.0 | Digital Twin 본 구축, Material Library, **Deformation Engine v1**, Edge Case Extractor v1, 수집환경 가동 |
| 3차년도 | 2.0 | 0.9 | 2.9 | **Engine v2**, Dataset 1차 릴리스, RFM Adapter·Benchmark, Robot HW 실증·Domain Gap 측정 |
| 4차년도 | 1.7 | 0.5 | 2.2 | **Engine v3**, Edge·Recovery Corpus 고도화, 재학습–재검증, 표준화, 최종 실증 |
| **합계** | **7.0** | **3.0** | **10.0** | |
...
!!! info "예산이 확정되면 범위와 함께 재산정합니다"
    **총사업비와 기관별 배분이 확정되면** 아래 순서로 수행범위를 넓힙니다. 반대로 더 줄여야
    하면 역순으로 좁힙니다. **어느 경우에도 대표 성과 세 축은 유지**하며, KPI 는 목표치만
    조정하고 지표 정의와 측정 방법은 바꾸지 않습니다.
...
인건비 3.2억에 대응하는 구성입니다. 최종 인원과 참여율은 확정 예산과 학사일정에 맞춰
