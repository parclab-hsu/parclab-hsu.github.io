...
| 확정 역할 | 비중 | 금액 | 대응 기술축 |
|---|---:|---:|---|
| ① Real-to-Sim-to-Real 고도화 | 36 % | **6.1억** | Manufacturing Deformation Engine |
| ② Zero-shot Transfer 도메인 적응 | 24 % | **4.1억** | 미학습 조건 평가 |
| ③ 엣지 케이스 시뮬레이션 | 25 % | **4.3억** | Human Data Engine · Ontology·Edge Case |
...
!!! warning "통보 문구와 금액의 모수가 다릅니다 — 협약 전 확인 필요"
    ...
    **총사업비 340억의 5 %** 에 해당하며, 공고문상 정부지원연구개발비(75억)의 5 %
    ...
    금액은 17억으로 확정된 것으로 알고 작성했으나, **협약서에 들어갈 근거 문구**가
    「정부지원연구개발비의 5 %」로 적히면 금액이 달라질 수 있습니다.
    **협약 전에 근거 문구와 금액을 함께 확인해야 합니다.**
